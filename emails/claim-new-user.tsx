...
export function renderClaimNewUserEmail({
  senderName,
  senderEmail,
  eventTitle,
  claimUrl,
  appUrl,
}: ClaimNewUserEmailProps) {
...
<head>
  ...
  <title>Claim your SignupSmartly invite</title>
  ...
  <div style="max-width: 600px; margin: 0 auto; padding: 24px;">
    <div style="background-color: #FFFFFF; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 2px 4px -1px rgba(0, 0, 0, 0.03);">
      ...
      <div style="padding: 24px;">
        ...
        <p style="margin: 0 0 16px;"><strong>${senderName}</strong> (${senderEmail}) set up a signup for you on SignupSmartly - <strong>"${eventTitle}"</strong> - and it's ready to go.</p>
        <p style="margin: 0 0 20px;">Create your free account to claim it and start sharing with volunteers.</p>
        ...
        <p style="margin: 20px 0 0;">SignupSmartly is a free tool for organizing volunteers. No credit card required.</p>
